...
> 📓 The analysis lives in **[`UAE_Sales_Forecasting.ipynb`](UAE_Sales_Forecasting.ipynb)** — GitHub renders it with all charts and outputs inline.
...
**[UAE Market Sales Analytics dashboard](https://uhvcw2pktadjl2y6ujrapp9.streamlit.app)**
(Streamlit + Plotly), which explores the same dataset descriptively. Together they
